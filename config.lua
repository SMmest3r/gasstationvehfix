...
Config.Blip = { -- Here you can set how the blips will look like. You can find the blip sprites and colours here: https://docs.fivem.net/docs/game-references/blips/
	sprite = 361,
	scale = 0.8,
	colour = 1,
	shortRange = true,
...
Config.Stations = { -- Coords are the center coordinates of the fix areas, radius is the radius of the fix area, blip true/false to toggle blip on/off
...
Config.OnFix = {
	sound = true, -- Play sound on vehicle fix (construction.ogg)
	flash = {
...
Config.Wait = {
	...
	coolwown = 45000 -- Wait time after a vehicle has been fixed before it can be fixed again (in milliseconds)
}
